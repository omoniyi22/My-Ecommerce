      ...
      <header className="bg-white">
        <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <div className="sm:flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 sm:text-3xl">Welcome Back,
            ...
            <div className="flex items-center gap-4 sm:mt-0 sm-flex-row sm:items-center">

              <Link
                className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-gray-200 px-5 py-3 text-gray-500  font-medium transition hover:text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring"
                type="button"
                href="/products"
              >
              ...
              <button
                ...
                border-orange-200 bg-white px-5 py-3 text-orange-900 transition 
                hover:text-orange-700 focus:outline-none focus:ring"
                type="button"
              >
